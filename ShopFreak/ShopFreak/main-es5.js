...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSellproductSellproductComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRouteTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _productregister_productregister_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./productregister/productregister.component */
    "./src/app/productregister/productregister.component.ts");
    /* harmony import */


    var _productdetails_productdetails_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var _sellproduct_sellproduct_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./sellproduct/sellproduct.component */
    ...
    var Main_routes = [{
      ...
      component: _productregister_productregister_component__WEBPACK_IMPORTED_MODULE_5__["ProductregisterComponent"]
    }, {
      path: 'productdetails',
      component: _productdetails_productdetails_component__WEBPACK_IMPORTED_MODULE_6__["ProductdetailsComponent"]
    }, {
      path: 'cart',
      component: _cart_cart_component__WEBPACK_IMPORTED_MODULE_7__["CartComponent"]
    }, {
      path: 'sellproduct',
      component: _sellproduct_sellproduct_component__WEBPACK_IMPORTED_MODULE_8__["SellproductComponent"]
    }, {
      path: '',
      redirectTo: '/login',
      pathMatch: 'full'
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _productregister_productregister_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./productregister/productregister.component */
    "./src/app/productregister/productregister.component.ts");
    /* harmony import */


    var _productdetails_productdetails_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./productdetails/productdetails.component */
    "./src/app/productdetails/productdetails.component.ts");
    /* harmony import */


    var _cart_cart_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./cart/cart.component */
    "./src/app/cart/cart.component.ts");
    /* harmony import */


    var _servicess_product_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ./servicess/product.service */
    "./src/app/servicess/product.service.ts");
    /* harmony import */


    var _sellproduct_sellproduct_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! ./sellproduct/sellproduct.component */
    "./src/app/sellproduct/sellproduct.component.ts"); //  import { EntitiesComponent } from './entities/entities.component';
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _mainpage_mainpage_component__WEBPACK_IMPORTED_MODULE_6__["MainpageComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_10__["LoginComponent"], _sign_sign_component__WEBPACK_IMPORTED_MODULE_11__["SignComponent"], _userdata_userdata_component__WEBPACK_IMPORTED_MODULE_17__["UserdataComponent"], _productregister_productregister_component__WEBPACK_IMPORTED_MODULE_18__["ProductregisterComponent"], _sellproduct_sellproduct_component__WEBPACK_IMPORTED_MODULE_22__["SellproductComponent"], _productdetails_productdetails_component__WEBPACK_IMPORTED_MODULE_19__["ProductdetailsComponent"], _cart_cart_component__WEBPACK_IMPORTED_MODULE_20__["CartComponent"]],
  ...
  function srcAppCartCartComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _servicess_product_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../servicess/product.service */
    "./src/app/servicess/product.service.ts"); // import { Component, OnInit } from '@angular/core';
      ...
      _createClass(CartComponent, [{
            ...
            if (id) {
              ...
              if (localStorage.getItem('cart') == null) {
                ...
                if (index == -1) {
                  ...
                  var _item = JSON.parse(_cart[index]);

                  _item.quantity += 1;
                  _cart[index] = JSON.stringify(_item);
                  localStorage.setItem("cart", JSON.stringify(_cart));
                }
              }
        ...
        value: function loadCart() {
          ...
          this.activatedRoute.params.subscribe(function (params) {
            ...
            if (id) {
              var item = {
                product: _this2.productService.find(id),
                quantity: 1
              };
            }
            ...
            for (var i = 0; i < cart.length; i++) {
              ...
              _this2.total += item.product.price * item.quantity;
            }
          });
        }
      }, {
        ...
        value: function remove(id) {
          ...
          this.activatedRoute.params.subscribe(function (params) {
            ...
            if (id) {
              var item = {
                product: _this3.productService.find(id),
                quantity: 1
              };
            }
    ...
    var LoginComponent = /*#__PURE__*/function () {
      ...
      function LoginComponent(router, service) {
        ...
        response.subscribe(function (data) {
          return _this4.credentials = data;
        });
      }
  ...
  function srcAppMainpageMainpageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MainpageComponent = /*#__PURE__*/function () {
      function MainpageComponent() {
        ...
        this.imageUrls = [this.myimage12, this.myimage11, this.myimage8, this.myimage10, this.myimage9];
        this.arrowSize = '30px';
  ...
  function srcAppProductTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Product = function Product(name, description, price, pnumber) {
  ...
  function srcAppProductdetailsProductdetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _servicess_product_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../servicess/product.service */
    "./src/app/servicess/product.service.ts");
    /* harmony import */


    var _product_registration_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var ProductdetailsComponent = /*#__PURE__*/function () {
      function ProductdetailsComponent(productService, service, router) {
      ...
      _createClass(ProductdetailsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.showUsers(); // console.log(this.product.subscribe())
        } //   findbyna()
        //   {
        //     this.flag=1;
        ...
        key: "cart1",
        value: function cart1(id) {
          console.log(id); // this.router.navigateByUrl('cart');
          ...
          if (localStorage.getItem('cart') == null) {
            ...
            var _cart2 = JSON.parse(localStorage.getItem('cart'));

            var index = -1;

            for (var i = 0; i < _cart2.length; i++) {
              // console.log(item.product);
              var Item = JSON.parse(_cart2[i]);
            ...
            if (index == -1) {
              ...
              var _item2 = JSON.parse(_cart2[index]);

              _item2.quantity += 1;
              _cart2[index] = JSON.stringify(_item2);
              localStorage.setItem("cart", JSON.stringify(_cart2));
            }
          }
        }
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return this.service.doProductRegistration(this.product);
  ...
  /***/
  function srcAppSellproductSellproductComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSellproductSellproductComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SellproductComponent", function () {
    ...
    var SellproductComponent = /*#__PURE__*/function () {
      function SellproductComponent(service, router) {
        _classCallCheck(this, SellproductComponent);
      ...
      _createClass(SellproductComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.flag = 1;
          this.product = this.service.productData();
    ...
    SellproductComponent.ctorParameters = function () {
      return [{
        type: _product_registration_service__WEBPACK_IMPORTED_MODULE_2__["ProductRegistrationService"]
      }, {
        type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]
    ...
    SellproductComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-sellproduct',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./sellproduct.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/sellproduct/sellproduct.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./sellproduct.component.css */
      "./src/app/sellproduct/sellproduct.component.css"))["default"]]
  ...
  /***/
  function srcAppServicessProductServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ProductService = /*#__PURE__*/function () {
      function ProductService() {
        ...
        this.products = [{
          ...
          name: 'Face Mask',
          price: 100,
          photo: 'PlanetMask1.jpg'
        }, {
          id: '5',
          name: 'iphone 11 Pro',
          price: 82000,
          photo: 'silkyCream.jpg'
        }, {
          id: '6',
          name: 'Denim Jacket',
          price: 4300,
          photo: 'sunnyCream.jpg'
        }, {
          id: '7',
          name: 'Nike Air Jordan 1',
          price: 3000,
          photo: 'norweigenCream.jpg'
        }, {
          id: '8',
          name: 'Microwave',
          price: 2670,
  ...
  function srcAppSignSignComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ../user */
    "./src/app/user.ts"); // import { formatNumber } from '@angular/common';
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\SIMRAN\Desktop\ShopFreak\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
